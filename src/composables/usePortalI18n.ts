...
const messages = {
  ...
  'en-US': {
    ...
    notificationsNoHistoryDescription: 'Read notifications will stay organized here for consultation.',
  ...
  'es-ES': {
    ...
    navGoals: 'Metas',
    navGoalsShort: 'Metas',
    navGoalsNote: 'Desafios, puntos y medallas',
    ...
    notificationsNoPendingDescription:
      'Cuando lleguen nuevos avisos no leidos, apareceran aqui.',
